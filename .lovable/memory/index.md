...
MODO DIOS: archivos REALES persistidos, sin bloques fallidos, sin warnings críticos, QuickActions contextuales reales, deploy-ready Netlify, GitHub estable, validar SIEMPRE (archivos+preview+reapertura) antes de responder. Arreglar lo roto antes de agregar features.
...
- [MODO DIOS — Builder standard](mem://preferences/builder-standard) — 15 reglas obligatorias permanentes para cada generación/edición del builder
